            ...
            {mintOK === true ? (
              ...
              <div className="w-full">
                <button
                  ...
                  className="w-full mt-4 bg-gradient-to-br from-purple-600 via-blue-500 to-green-300 hover:from-indigo-600 hover:via-pink1-600 hover:to-red-600 rounded-full text-white font-light text-lg px-3 py-3"
                >
                  Mint NFT
                </button>
              </div>
