                              ...
                              <span className="">
                                <span class="">
                                  <Popover className="absolute mx-auto">
                                    {({ open }) => (
                                      <div className="flex flex-col text-gray-300">
                                        <Popover.Button className="absolute transform -translate-y-0.5 -translate-x-7 p-3">
                                          <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="16"
                                            height="16"
                                        ...
                                        >
                                          <Popover.Panel
                                            static
                                            className="z-999 w-60 mx-auto"
                                          >
                                            <div className="absolute transform translate-y-3 right-48 -translate-x-9 rounded border -top-44 z-999">
