...
export default function Landing() {
  return (
    <section className="text-gray-600 body-font">
      <div className="mt-0 lg:mt-32 max-w-8xl mx-auto flex justify-center transform  pt-24 pb-20 lg:pb-64 md:pb-96 lg:pb-28 mb-24 md:mb-56 lg:flex-row flex-col">
          ...
          <div className="  flex flex-col justify-end">
            ...
            <div className=" flex inline-flex justify-center">
              <a
                ...
                href="/market"
              >
                <span className="w-24 flex justify-center">Visit Market</span>
              </a>
              <a
                ...
                href="/faq"
              >
                <span className="w-24 flex justify-center">Learn More!</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="flex-mx-auto w-full lg:w-1/3 max-h-96 items-center mt-16 lg:-mt-24">
          <img
            className=" w-5/6 lg:w-full transform lg:translate-x-20 rotate-3  flex mx-auto"
            alt="Landing"
