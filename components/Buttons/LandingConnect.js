...
export default function Home() {
  ...
  return (
    <div>
      <header>
        <button className="bg-gradient-to-r from-purple-600 via-blue-500 to-green-300 hover:from-indigo-600 hover:via-pink1-600 hover:to-red-600 inline-flex items-center px-12 py-3 mt-4 font-normal text-white   active:bg-blue-600 rounded-md text-md md:mt-0">
